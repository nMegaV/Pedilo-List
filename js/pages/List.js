    ...
    template: `
        ...
        <main v-else class="page-list">
            <div class="list-container">
                <div class="search">
                    <input type="text" v-model="search" placeholder="Buscar nivel..." class="type-label-lg" />
                </div>
                <table class="list" v-if="list">
                    ...
                    <tr v-if="filteredList.length === 0">
                        <td colspan="2" style="text-align: center;">
                            <p class="type-label-lg">Ningún nivel encontrado</p>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <ul class="stats">
                        ...
                        <li>
                            ...
                            <button class="copy" @click="copy(level.id, 'id')">
                                <p>{{ level.id }}</p>
                                <span class="type-label-sm">{{ copied === 'id' ? '¡Copiado!' : 'Copiar' }}</span>
                            </button>
                        </li>
                        <li>
                            <div class="type-title-sm">Password</div>
                            <button class="copy" @click="copy(level.password || 'Free to Copy', 'password')">
                                <p>{{ level.password || 'Free to Copy' }}</p>
                                <span class="type-label-sm">{{ copied === 'password' ? '¡Copiado!' : 'Copiar' }}</span>
                            </button>
                        </li>
                    </ul>
                    <h2>Records</h2>
    ...
    methods: {
        ...
        async copy(text, field) {
            try {
                ...
                this.errors.push("No se pudo copiar al portapapeles.");
            }
        },
    },
};
